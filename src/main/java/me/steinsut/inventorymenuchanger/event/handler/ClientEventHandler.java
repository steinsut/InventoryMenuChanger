...
import me.steinsut.inventorymenuchanger.gui.EntryScrollPanel;
...
public class ClientEventHandler {
    ...
    private EntryScrollPanel panel;
    private Class<?> guiClass;

    public ClientEventHandler(InventoryMenuChanger modInstance, IEventBus minecraftBus) {
    ...
    private void onPostScreenInit(ScreenEvent.Init.Post event) {
        ...
        if (Registries.ENTRIES.getAllClasses().contains(this.guiClass)
            ...
            this.panel = new EntryScrollPanel(26, height, (screen.height / 2) - height / 2, 0);
